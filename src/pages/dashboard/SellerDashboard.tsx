    ...
    <div className="bg-[#f9f9ff] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          ...
          {/* Seller Income */}
          <Link to="/seller/reports/income" className="block group">
            <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-5 h-full hover:shadow-md transition-shadow duration-200">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs font-medium text-primary-600 group-hover:text-primary-700">View Report</span>
              </div>
